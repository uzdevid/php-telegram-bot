 ...
 *
 * Typical usage: instantiate the method with the required 'latitude', 'longitude', 'title', and
 * 'address' fields, then chain optional builder methods before dispatching the request.
 *
 * @link https://core.telegram.org/bots/api#sendvenue
 */
class SendVenue extends Method implements MethodInterface {
    /**
     * Creates a new SendVenue method and sets the required 'latitude', 'longitude', 'title', and
     * 'address' fields.
     *
     ...
     *
     * @param string $foursquareType Foursquare type of the venue, if known. (For example,
