...
class SendDocument extends Method implements MethodInterface {
    /**
     * Creates a new SendDocument method and sets the required 'document' field.
     *
     * @param string $document File to send. Pass a file_id as String to send a file that exists on
     *   the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to get a file
     *   from the Internet, or upload a new one using multipart/form-data. More information on
     *   Sending Files »
     */
