...
class SendAudio extends Method implements MethodInterface {
    /**
     * Creates a new SendAudio method and sets the required 'audio' field.
     *
     * @param string $audio Audio file to send. Pass a file_id as String to send an audio file that
     *   exists on the Telegram servers (recommended), pass an HTTP URL as a String for Telegram to
     *   get an audio file from the Internet, or upload a new one using multipart/form-data. More
