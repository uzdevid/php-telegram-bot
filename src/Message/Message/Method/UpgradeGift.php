...
class UpgradeGift extends Method implements MethodInterface {
    /**
     * Creates a new UpgradeGift method and sets the required 'business_connection_id' and
     * 'owned_gift_id' fields.
     *
     * @param string $businessConnectionId Unique identifier of the business connection
     * @param string $ownedGiftId Unique identifier of the regular gift that should be upgraded to a
     *   unique one
     */
     ...
     * can_transfer_stars business bot right is required and gift.upgrade_star_count must be passed.
     *
     * @param int $starCount The amount of Telegram Stars that will be paid for the upgrade from the
