...
class EditMessageLiveLocation extends Method implements MethodInterface {
    /**
     * Creates a new EditMessageLiveLocation method and sets the required 'latitude' and 'longitude'
     * fields.
     *
     ...
     *
     * @param int $livePeriod New period in seconds during which the location can be updated,
