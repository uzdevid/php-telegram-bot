...
class AnswerCallbackQuery extends Method implements MethodInterface {
    /**
     * Creates a new AnswerCallbackQuery method and sets the required 'callback_query_id' field.
     *
     ...
     *
     * @param string $url URL that will be opened by the user's client. If you have created a Game
