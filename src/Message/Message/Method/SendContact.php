 ...
 *
 * Typical usage: instantiate the method with the required 'phone_number' and 'first_name' fields,
...
class SendContact extends Method implements MethodInterface {
    /**
     * Creates a new SendContact method and sets the required 'phone_number' and 'first_name'
     * fields.
     *
