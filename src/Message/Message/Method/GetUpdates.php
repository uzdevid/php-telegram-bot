...
class GetUpdates extends Method implements MethodInterface {
     ...
     *
     * @param int $offset Identifier of the first update to be returned. Must be greater by one than
     *   the highest among the identifiers of previously received updates. By default, updates
     ...
     * the call to getUpdates, so unwanted updates may be received for a short period of time.
     *
