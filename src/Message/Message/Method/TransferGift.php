...
class TransferGift extends Method implements MethodInterface {
    /**
     * Creates a new TransferGift method and sets the required 'business_connection_id',
     * 'owned_gift_id', and 'new_owner_chat_id' fields.
     *
     * @param string $businessConnectionId Unique identifier of the business connection
     * @param string $ownedGiftId Unique identifier of the regular gift that should be transferred
     * @param int $newOwnerChatId Unique identifier of the chat which will own the gift. The chat
     *   must be active in the last 24 hours.
     */
